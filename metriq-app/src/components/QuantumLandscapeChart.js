    ...
    <span>
      ...
      <div className='row'>
        <div className='col text-start'>
          ...
          <p>If you have other data you would like to see added to this chart please either make a pull-request on Metriq to the <a href='https://github.com/unitaryfoundation/metriq-web/blob/main/metriq-app/src/progress.csv'>progress chart CSV file</a> directly or email <a href='mailto:metriq@unitary.foundation'>metriq@unitary.foundation</a>.</p>
          ...
          <p>To have new data point additions of your own considered for inclusion in the chart, please open a pull request on GitHub against <a href='https://github.com/unitaryfoundation/metriq-web/blob/main/metriq-app/src/progress.csv'>the chart data file</a>.</p>
        </div>
      </div>
      <div className='row'>
        <div className='col text-start'>
