  ...
  render () {
    return (
      <div id='metriq-main-content' className='container'>
        ...
        <p>The Metriq Python client (metriq-client) and API (metriq-api) are compatible with the QED-C repository and enable addition of new data points on metriq.info. You can read more about automatically running QED-C benchmarks on Metriq in <a href='https://unitary.foundation/posts/2023_metriq_qedc.html'>this blog post</a> on the Unitary Foundation website.</p>
