    ...
    <span>
      ...
      <div className='row'>
        <div className='col text-start'>
          ...
          <p>To have new data point additions of your own considered for inclusion in the chart, please open a pull request on GitHub against <a href='https://github.com/unitaryfoundation/metriq-app/blob/main/src/progress.csv'>the chart data file</a>.</p>
        </div>
      </div>
      <div className='row'>
        <div className='col text-start'>
