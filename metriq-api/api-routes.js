...
router.route('/user/:userId')
  .get(userController.readPublic)
router.route('/user/follows/tasks')
  .get(userController.followedTasks)
...
router.route('/submission/:id/results')
  .get(resultController.read)
